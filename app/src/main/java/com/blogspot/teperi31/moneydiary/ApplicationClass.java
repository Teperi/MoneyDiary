...
public class ApplicationClass extends Application {
	...
	public void onCreate() {
		...
		dList.add(new DataDiary(1, new GregorianCalendar(2018,9,25).getTime(), "월급날이다!", "신나는 월급", null));
		dList.add(new DataDiary(2, new GregorianCalendar(2018,9,26).getTime(), "이쁜 고양이", "이 고양이 사진이 최고인거 같다.",Uri.parse("android.resource://com.blogspot.teperi31.moneydiary/drawable/" + R.drawable.cat3)));
